import{j as u,r as d,R as y,a as p,b as g,c as w,B as b}from"./vendor.534535c0.js";const v=function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))l(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const e of a.addedNodes)e.tagName==="LINK"&&e.rel==="modulepreload"&&l(e)}).observe(document,{childList:!0,subtree:!0});function c(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerpolicy&&(a.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?a.credentials="include":t.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function l(t){if(t.ep)return;t.ep=!0;const a=c(t);fetch(t.href,a)}};v();const r=u.exports.jsx,m=u.exports.jsxs,f=d.exports.createContext();function k({children:n}){function s(h){return Array.from(new Set(h))}let c=`My wish is to become a tennis player in the future.
...
`;const[l,t]=d.exports.useState(s(c.split(" "))),[a,e]=d.exports.useState(),[i,o]=d.exports.useState();return r(f.Provider,{value:{edit:a,setEdit:e,db:l,setDb:t,rec:i,setRec:o},children:n})}const I=()=>{var a;const n=d.exports.useContext(f),s=e=>{var o;return(o=n.db)==null?void 0:o.filter(h=>h.startsWith(e)&&h.length)};function c(e){return Array.from(new Set(e))}function l(e){const i=e.target.value.split(" "),o=i.length;n.setEdit(e.target.value),n.setRec(s(i[o-1]))}function t(e){var i;if(e.keyCode==9){e.preventDefault();let o=(i=n==null?void 0:n.edit)==null?void 0:i.split(" ");o==null||o.pop(),o==null||o.push(n.rec[0]);let h=o==null?void 0:o.join(" ");n==null||n.setEdit(h)}}return window.addEventListener("keydown",t),m("div",{children:[r("div",{className:"scroll mt-1",children:(a=n.rec)==null?void 0:a.map(e=>r("button",{className:"btn card",children:e},e))}),r("div",{className:"dart-center mt-1",children:r("textarea",{className:"editor ",value:n.edit,onChange:l,onKeyDown:e=>{e.keyCode==32&&n.setDb(c([...n.db,...n.edit.split(" ")]))}})})]})},x=()=>m("div",{children:[r("h1",{className:"card",children:"app"}),r(y,{children:r(p,{path:"*",element:r(I,{})})})]});g.render(r(w.StrictMode,{children:r(b,{children:r(k,{children:r(x,{})})})}),document.getElementById("root"));
